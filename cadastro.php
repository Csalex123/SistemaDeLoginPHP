...
<body>
    ...
    <div id="corpo">
        ...
        <form action="efetuarLogin.php" method="POST" >
            ...
            <input type="password" name="senha" class="placeholder" placeholder="Preencha sua Senha">
            <input type="password" name="confirmarSenha" class="placeholder" placeholder="Confirmar senha">
